       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <br><h1 class="h3 mb-0 text-gray-800">View Student Attendance</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Enter Your Details</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    ...
                    <input type="text" class="form-control" required name="admissionNumber" placeholder = "Enter Roll Number" id="exampleInputFirstName" >
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Your Branch<span class="text-danger ml-2">*</span></label>
                         <?php
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Current Semester<span class="text-danger ml-2">*</span></label>
                         <?php
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="">--Select Current Semester--</option>';
                          while ($rows = $result->fetch_assoc()){
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Your Attendance Details</h6>
                </div>
                <div class="table-responsive p-3">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                      ...
                      $namequery="SELECT tblstudents.Id,tblstudents.firstName,tblclass.className,tblbranch.branchName,
                      tblstudents.lastName
                      FROM tblstudents
                      INNER JOIN tblclass ON tblclass.Id = tblstudents.classId
                      INNER JOIN tblbranch ON tblbranch.Id = tblstudents.branchId
                      where tblstudents.classId = '$classId' and tblstudents.branchId = '$branchId' and tblstudents.admissionNumber = '$admissionNumber' ";
                      $rsin = $conn->query($namequery);
                      $info = $rsin->fetch_assoc();
                    
                               echo"<h5>  Hi, ".$info['firstName']." ".$info['lastName']." - ".$info['branchName']." - ".$info['className']." Semester </h5> <br>";
