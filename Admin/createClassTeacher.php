...
if(isset($_POST['save'])){
  ...
  $classArmId=$_POST['classArmId'];
    ...
    $query=mysqli_query($conn,"INSERT into tblclassteacher(firstName,lastName,emailAddress,password,branchId,classId,classArmId) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$branchId','$classId','$classArmId')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['classArmId']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        $Id= $_GET['Id'];
        $classArmIdprev= $_GET['classArmId'];
    ...
    emailAddress='$emailAddress', password='$password',branchId='$branchId', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                $quprev=mysqli_query($conn,"update tblclassarms set isAssigned='0' where Id ='$classArmIdprev'");
                $qu=mysqli_query($conn,"update tblclassarms set isAssigned='1' where Id ='$classArmId'");
                    if ($qu && $quprev) {
...
<?php include 'includes/title.php';?>
  ...
  <link href="css/ruang-admin.min.css" rel="stylesheet">
   ...
   let bId;
   let cId;
   function classArmDropdown(cId,bId) {
    if (cId == "" || bId == "") {
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create & Assign Classes to Faculty</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Assign Subjects</h6><br>
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblclassteacher.Id,tblbranch.branchName, tblclass.className,tblclassarms.classArmName,tblclassarms.Id AS classArmId,tblclassteacher.firstName,
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='?action=edit&Id=".$rows['Id']."&classArmId=".$rows['classArmId']."'><i class='fas fa-fw fa-edit'></i></a></td>
