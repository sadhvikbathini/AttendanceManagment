...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from tblclassarms where classArmName ='$classArmName' and classId = '$classId' and branchId = '$branchId'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into tblclassarms(branchId,classId,classArmName,isAssigned) value('$branchId','$classId','$classArmName','0')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update tblclassarms set branchId = '$branchId' , classId = '$classId', classArmName='$classArmName' where Id='$Id'");
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblclassarms.Id,tblclassarms.isAssigned,tblbranch.branchName,tblclass.className,tblclassarms.classArmName 
                      FROM tblclassarms
                      INNER JOIN tblclass ON tblclass.Id = tblclassarms.classId 
                      INNER JOIN tblbranch ON tblbranch.Id = tblclassarms.branchId";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
